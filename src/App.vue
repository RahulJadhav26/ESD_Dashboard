<template>
  ...
  ></v-img> -->
    <!-- {{sessionUser}} -->
      ...
      <!-- <v-btn  class="text" text @click="logout"> Logout</v-btn> -->
     <!-- <v-btn icon>
        <v-icon color="">mdi-account-circle</v-icon>
      </v-btn><span style="font-size:12px;">{{sessionUser}}</span> -->
    </v-app-bar>
    <v-main>
      <router-view/>
    </v-main>
    ...
    >
      ...
      >
        ...
        <br>
          ...
          <v-list-item href='/addSiteBuilding'>
            <v-list-item-icon>
              <v-icon>mdi-account</v-icon>
            </v-list-item-icon>
            <v-list-item-title>Add  Site Building</v-list-item-title>
          </v-list-item>
          <v-list-item href='/addSensor'>
            <v-list-item-icon>
              <v-icon>mdi-account</v-icon>
            </v-list-item-icon>
